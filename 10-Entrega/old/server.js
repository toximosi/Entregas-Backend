...
import __dirname from './utils.js.js';//static files
import { Server } from 'socket.io';//


//wiews
import handlebars from 'express-handlebars';//motor de plantillas
import viewsRouter from './routers/views.router.js.js';
//routers
import productsRouter from './routers/products.router.js.js';
import chastsRouter from './routers/chatsBd.router.js.js';
